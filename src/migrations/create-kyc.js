...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('Kycs', {
      ...
      codeFront: { type: Sequelize.STRING, allowNull: true },
      codeBack: { type: Sequelize.STRING, allowNull: true },
      codeFace: { type: Sequelize.STRING, allowNull: true },
      codeSSN: { type: Sequelize.STRING, allowNull: true },
      codeLicense: { type: Sequelize.STRING, allowNull: true },
      codeEIN: { type: Sequelize.STRING, allowNull: true },
      codePassport: { type: Sequelize.STRING, allowNull: true },
